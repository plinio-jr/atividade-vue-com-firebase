<template>
  <v-app>
    <v-app-bar app color="red" dark elevation="1">
  ...
  <v-icon>mdi-account</v-icon>
    ...
    <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
     <v-list dense color="red" dark>
      ...
      <v-list-item @click="mini = ! mini">
        ...
        <v-list-item-content>Plinio Arruda Jr</v-list-item-content>
    ...
    <v-footer app class="py-3"><span class="caption">Lista de Tarefas &copy; 2022</span></v-footer>
  </v-app>
</template>
