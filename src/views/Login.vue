<template>
  <v-container fill-height fluid text-center>
      <v-container>
          <v-row>
              <v-col class="secondary--text text-center mx-auto pb-4" cols="1" sm="4" offset="4">
              ...
              <v-col>
                  <v-form>
                      ...
                      <v-btn color="red" @click="login">Login</v-btn>
                       <v-btn class="ml-4" color="yellow" @click="reset">Cancelar</v-btn>
                  </v-form>
              </v-col>
          </v-row>
      </v-container>
      <v-snackbar color="red" v-model="errorLogin" danger multline timeout="2000">
          ...
          <v-dialog v-model="novaConta" persistent max-width=300>
              <v-card>
                  ...
                  <v-card-actions>
                      <v-spacer></v-spacer>
                      <v-btn color="blue darken-4" text @click="criarNovaConta">Sim</v-btn>
